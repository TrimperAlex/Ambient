...
we1 = WeatherEvent.create!(description: "Summer shinny day", temperature: 30, category: "sun", image_url: "summer.jpg", owner_id: user1.id)
puts "weather_event #{we1.id} of user #{we1.owner.first_name} created"
we2 = WeatherEvent.create!(description: "Snowstorm Stay at home day", temperature: -10, category: "snow", image_url: "snow.jpg", owner_id: user2.id)
puts "weather_event #{we2.id} of user #{we2.owner.first_name} created"
we3 = WeatherEvent.create!(description: "Lightning day", temperature: 25, category: "thunderstorm", image_url: "lightning.jpg", owner_id: user3.id)
puts "weather_event #{we3.id} of user #{we3.owner.first_name} created"
we4 = WeatherEvent.create!(description: "Vancouver daily day", temperature: 10, category: "rain", image_url: "rain.jpg", owner_id: user4.id)
