...
we1 = WeatherEvent.create!(description: "Summer shiny day", temperature: 30, category: "sun", image_url: "https://res.cloudinary.com/dqxyjgr8m/image/upload/v1668722140/scmioqifelyeflzulk1i.jpg", price: 1000, owner_id: user1.id)
